...
/* 33 */
/*!************************************************!*\
  !*** P:/uniapp/first/uni.promisify.adaptor.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _category = _interopRequireDefault(__webpack_require__(/*! ./modules/category */ 42));
var _cart = _interopRequireDefault(__webpack_require__(/*! ./modules/cart */ 43));
/*
	使用vuex作为数据管理仓库，主入口
*/
...
/* 36 */
/*!*********************************************!*\
  !*** P:/uniapp/first/store/modules/home.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var state = {
  ...
  categoryList: [],
  policyDescList: [{
    icon: "/static/images/fixed-icon1.png",
    schemeUrl: "",
    desc: "网易自营品牌"
  }, {
    icon: "/static/images/fixed-icon2.png",
    schemeUrl: "",
    desc: "30天无忧退货"
  }, {
    icon: "/static/images/fixed-icon3.png",
    schemeUrl: "",
    desc: "48小时快速退款"
  }],
  navList: [{
    icon: "/static/images/nav-icon1.png",
    desc: "居家生活"
  }, {
    icon: "/static/images/nav-icon2.png",
    desc: "服饰箱包"
  }, {
    icon: "/static/images/nav-icon3.png",
    desc: "美食酒水"
  }, {
    icon: "/static/images/nav-icon4.png",
    desc: "个护清洁"
  }, {
    icon: "/static/images/nav-icon5.png",
    desc: "母婴亲子"
  }, {
    icon: "/static/images/nav-icon6.png",
    desc: "运动旅行"
  }, {
    icon: "/static/images/nav-icon7.png",
    desc: "数码家电"
  }, {
    icon: "/static/images/nav-icon8.png",
    desc: "全球特色"
  }, {
    icon: "/static/images/nav-icon9.png",
    desc: "好货抄底"
  }, {
    icon: "/static/images/nav-icon10.png",
    desc: "其他商品"
  }],
  categoryExList: [{
    titlePicUrl: "https://yanxuan.nosdn.127.net/6dcb40c6818b892aa9a51d8928705211.jpg?type=webp&imageView&&thumbnail=1090x310&quality=95",
    items: [{
      picUrl: "https://yanxuan-item.nosdn.127.net/ac931886418a1cc7f448f83144502048.png?type=webp&quality=95&thumbnail=265x265&imageView",
      desc: "裸睡亲肤 经典A类针织四件套"
    }, {
      picUrl: "https://yanxuan-item.nosdn.127.net/8b9d1671522b1551bbbdd02aacc922bf.jpg?type=webp&quality=95&thumbnail=265x265&imageView",
      desc: "每一口都有九种肉，全价猫粮"
    }, {
      picUrl: "https://yanxuan-item.nosdn.127.net/9d6a8c087e9ded5c828c74741a77bd14.jpg?type=webp&quality=95&thumbnail=265x265&imageView",
      desc: "吸湿发热，牛奶绒暖炎床笠套件"
    }, {
      picUrl: "https://yanxuan-item.nosdn.127.net/239d5177c8d6b0643d6d468dea904260.png?type=webp&quality=95&thumbnail=265x265&imageView",
      desc: "如享云端好眠 泰国93%天然乳胶床垫7.5-10cm"
    }, {
      picUrl: "https://yanxuan-item.nosdn.127.net/ac606893c49141e695354552c51e76e8.png?type=webp&quality=95&thumbnail=265x265&imageView",
      desc: "双12省钱卡 花3元得29元"
    }]
  }, {
    titlePicUrl: "https://yanxuan.nosdn.127.net/3768fa50dd5ca3aa0537a72990b48554.jpg?type=webp&imageView&&thumbnail=1090x310&quality=95",
    items: [{
      picUrl: "https://yanxuan-item.nosdn.127.net/ac931886418a1cc7f448f83144502048.png?type=webp&quality=95&thumbnail=265x265&imageView",
      desc: "裸睡亲肤 经典A类针织四件套"
    }, {
    ...
    titlePicUrl: "https://yanxuan.nosdn.127.net/3297667a12ee6b8f6203ff81754dd1cd.jpg?type=webp&imageView&&thumbnail=1090x310&quality=95",
    items: [{
      picUrl: "https://yanxuan-item.nosdn.127.net/ac931886418a1cc7f448f83144502048.png?type=webp&quality=95&thumbnail=265x265&imageView",
      desc: "裸睡亲肤 经典A类针织四件套"
    }, {
...
var mutations = {
  // 修改分类数据
  setCategoryListMutations: function setCategoryListMutations(state, list) {
...
var actions = {
  // 请求后端数据，获取分类信息
  getCategoryListActions: function getCategoryListActions(context) {
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _request.default)('role/search', {
                id: 1,
                id_handle: 1
              }, 'POST');
            case 2:
...
/* 40 */
/*!****************************************!*\
  !*** P:/uniapp/first/utils/request.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _base = _interopRequireDefault(__webpack_require__(/*! ./base.js */ 41));
var _default = function _default(url) {
  var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'GET';
  return new Promise(function (resolve, reject) {
    uni.request({
      url: _base.default.host + ':' + _base.default.port + '/' + url,
      data: data,
      method: method,
...
/* 42 */
/*!*************************************************!*\
  !*** P:/uniapp/first/store/modules/category.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var mutations = {
  setCategoryDataMutations: function setCategoryDataMutations(state, data) {
    state.categoryData = data;
  }
};
var actions = {
  getCategoryDataActions: function getCategoryDataActions(context) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
      var result;
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _request.default)('common/get-resource', {
                params: {
                  filename: "category-data.json"
                }
              }, 'POST');
            case 2:
              result = _context.sent;
...
/* 43 */
/*!*********************************************!*\
  !*** P:/uniapp/first/store/modules/cart.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var mutations = {
  addToCartListMutation: function addToCartListMutation(state, item) {
    var goodsItem = state.cartList.find(function (goodsItem) {
      return goodsItem.goodsId === item.goodsId;
    });
    if (goodsItem) {
      goodsItem.count += 1;
    } else {
      ...
      // item.count = 1;
      // item.selected = 1;
      _vue.default.set(item, 'count', 1);
      _vue.default.set(item, 'selected', 1);
      state.cartList.push(item);
    }
  },
  addCountMutation: function addCountMutation(state, id) {
  ...
  subCountMutation: function subCountMutation(state, id) {
    var item = state.cartList.find(function (item) {
      return item.goodsId === id;
    });
  ...
  removeItemMutation: function removeItemMutation(state, id) {
  ...
  setCheckedMutation: function setCheckedMutation(state, id) {
    var item = state.cartList.find(function (item) {
      return item.goodsId === id;
    });
    if (item) {
  ...
  changeAllCheckedMutation: function changeAllCheckedMutation(state, flag) {
    console.log('flag is ', flag);
    if (flag) {
      var items = state.cartList.filter(function (item) {
      ...
      var _items = state.cartList.filter(function (item) {
        return item.selected === 1;
      });
...
var actions = {
  addItemCountAction: function addItemCountAction(context, id) {
    context.commit('addCountMutation', id);
  },
  subItemCountAction: function subItemCountAction(context, id) {
...
var getters = {
  ...
  totalSelectedCount: function totalSelectedCount(state) {
    return state.cartList.filter(function (item) {
      return item.selected === 1;
    }).length;
  },
  totalSelectedPrice: function totalSelectedPrice(state) {
    var totalPrice = 0;
    ...
    // 使用reduce实现
    totalPrice = state.cartList.reduce(function (pre, item) {
